...
class caigou2003_zhaobSpider(CrawlSpider):
    ...
    start_urls = ['http://it.caigou2003.com/ITbiaoxun/zhaobiao/index.html']

    for i in xrange(2, 1948, 1):
        start_urls.append(
            "http://it.caigou2003.com/ITbiaoxun/zhaobiao/index_{}.html".format(
                i))
    ...
    def parse_item(self, response):
        ...
        l.add_value("crl_30101003", u"IT采购网")
