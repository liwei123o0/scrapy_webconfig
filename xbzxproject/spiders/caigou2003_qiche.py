...
class caigou2003_zhaobSpider(CrawlSpider):
    ...
    start_urls = ['http://qiche.caigou2003.com/qichebiaoxun/zhaobiao/index.html']

    for i in xrange(2, 949, 1):
        start_urls.append(
            "http://qiche.caigou2003.com/qichebiaoxun/zhaobiao/index_{}.html".format(
                i))
    ...
    def parse_item(self, response):
        ...
        l.add_value("crl_30101003", u"汽车采购网")
