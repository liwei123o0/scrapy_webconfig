...
class caigou2003_zhaobSpider(CrawlSpider):
    ...
    start_urls = ['http://jiaju.caigou2003.com/jiajubiaoxun/zhaobiao/index.html']

    for i in xrange(2, 343, 1):
        start_urls.append(
            "http://jiaju.caigou2003.com/jiajubiaoxun/zhaobiao/index_{}.html".format(
                i))
    ...
    def parse_item(self, response):
        ...
        l.add_value("crl_30101003", u"家具采购网")
